interface CaseFileEmptyStateProps {
  onCreate: () => void
}

export default function CaseFileEmptyState({ onCreate }: CaseFileEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-white px-6 py-16 text-center">
      ...
      <h3 className="mb-2 text-lg font-semibold text-txt">No tienes trámites registrados</h3>
      <p className="mb-6 max-w-sm text-sm text-txt-muted">
        Crea un trámite para comenzar a gestionar licencias de funcionamiento o inspecciones ITSE.
      </p>
