...
export default function Register() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-10rem)] max-w-md items-center px-4 py-12">
      <div className="w-full rounded-lg border border-border bg-white p-8 shadow-md">
