        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {features.map((f) => (
              ...
              >
                <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-full ${f.color === 'primary' ? 'bg-primary/10 text-primary' : 'bg-accent/10 text-accent'}`}>
                  {f.icon}
                </div>
          ...
          <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-3 md:gap-4">
            {steps.map((s, i) => (
              <div key={s.num} className="relative flex flex-col items-center text-center">
                <div className={`mb-4 flex h-14 w-14 items-center justify-center rounded-full text-xl font-bold text-white ${s.color === 'primary' ? 'bg-primary' : 'bg-accent'}`}>
                  {s.num}
                </div>
